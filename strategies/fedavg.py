...
The content of this file belongs to flower. See Disclaimer README.
...
from .aggregate import aggregate, weighted_loss_avg, MetricsAggregationFn
...
class _FedAvg(FedAvg):
    """Extends FedAvg with weighted aggregate
